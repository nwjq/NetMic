...
- 记录(01:05+08)：`scripts/verify_mvp.py` 仍为 M0–M3 gates 全 pass；Hub 中 `M1-client-kind-framing-20260127-1` 已被 `builder-linux` 认领，`M1-002-server-udp-receiver` / `M1-datagram-wrap-20260127-1` 为 done；scribe 继续优先推进 `M1-001-protocol-doc`。
